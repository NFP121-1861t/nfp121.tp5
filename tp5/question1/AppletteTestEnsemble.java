    ...
    private void initComponents() {// GEN-BEGIN:initComponents
        ...
        button1.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    AppletteTestEnsemble.this.unionActionPerformed(ae);
                }
            }
        );  
        ...
        button2.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    AppletteTestEnsemble.this.intersectionActionPerformed(ae);
                }
            }  
        );
        ...
        button3.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    AppletteTestEnsemble.this.differenceActionPerformed(ae);
                }
            }  
        );
        ...
        button4.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    AppletteTestEnsemble.this.diffSymetriqueActionPerformed(ae);
                }
            }  
        );
